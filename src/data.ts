...
export const PRESET_SHOWCASE_SAMPLES: PresetSampleItem[] = [
  {
    id: 'sample-lightbulb',
    name: 'tech_innovation_lightbulb_laptop.jpg',
    title: '💡 科技靈感燈泡與筆電',
    categoryTag: '科技與抽象 AI',
    badge: '熱門榜首 #01',
    imageUrl: '/samples/tech_innovation_lightbulb_laptop.jpg',
  ...
  },
  {
    ...
    name: 'data_science_learning_books.jpg',
    title: '📚 數據科學與電子學習',
    categoryTag: '教育與大數據',
    badge: '熱銷爆款 #02',
    imageUrl: '/samples/data_science_learning_books.jpg',
  ...
  {
    id: 'sample-courier',
    name: 'ecommerce_delivery_handover.jpg',
    title: '📦 電商包裹物流交接',
    categoryTag: '物流與電商',
    badge: '高轉換率 #03',
    imageUrl: '/samples/ecommerce_delivery_handover.jpg',
  ...
  {
    id: 'sample-ai-robot',
    name: 'ai_robot_healthcare_doctor.jpg',
    title: '🤖 智慧醫療與 AI 機器人',
    categoryTag: 'AI 醫療科技',
    badge: '精選範例 #04',
    imageUrl: '/samples/ai_robot_healthcare_doctor.jpg',
  ...
  },
  {
    ...
    name: 'esg_solar_panels_engineer.jpg',
    title: '🌱 永續綠能與太陽能電廠',
    categoryTag: 'ESG 綠能永續',
    badge: '高需求趨勢 #05',
    imageUrl: '/samples/esg_solar_panels_engineer.jpg',
  ...
  },
  {
    ...
    name: 'corporate_strategy_analytics.jpg',
    title: '💼 跨國企業戰略簡報',
    categoryTag: '商業與團隊',
    badge: '經典必備 #06',
    imageUrl: '/samples/corporate_strategy_analytics.jpg',
  ...
  },
  {
    ...
    name: 'artisanal_pour_over_coffee.jpg',
    title: '☕ 精品咖啡手沖與生活美學',
    categoryTag: '美食與飲食',
    badge: '美學特選 #07',
    imageUrl: '/samples/artisanal_pour_over_coffee.jpg',
  ...
  },
  {
    ...
    name: 'smartwatch_fitness_runner.jpg',
    title: '🏃 智慧手錶與運動健康',
    categoryTag: '運動與健康',
    badge: '運動爆款 #08',
    imageUrl: '/samples/smartwatch_fitness_runner.jpg',
  ...
  },
  {
    ...
    name: 'isometric_fintech_crypto_dashboard.jpg',
    title: '📊 3D 立體金融與數位貨幣',
    categoryTag: '金融與 3D 插畫',
    badge: '高單價 #09',
    imageUrl: '/samples/isometric_fintech_crypto_dashboard.jpg',
